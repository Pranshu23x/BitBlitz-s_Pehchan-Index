...
function StateDetails() {
  ...
  const updateTypeData = useMemo(() => {
    return [
      { name: 'Fresh Enrolments', value: 35 },
        { name: 'Biometric/Demographic Revisions', value: 25 },
        { name: 'Address & Mobile Corrections', value: 40 },
    ];
  }, []);
...
<span className="font-semibold text-amber-900">Actionable Intelligence:</span>{' '}
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <motion.div 
              className="rounded-xl p-5 transition-all duration-300 hover:shadow-[0_20px_45px_rgba(59,130,246,0.12),0_10px_25px_rgba(0,0,0,0.08)]"
              style={{ 
                background: 'linear-gradient(145deg, #fdfcfa 0%, #f9f7f5 100%)',
              ...
              {...cardHoverProps}
            >
              <h3 className="text-sm font-semibold text-slate-900 mb-5">Service Request Breakdown</h3>
              <div className="space-y-4">
                {updateTypeData.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold" style={{ color: colors[idx] }}>{item.value}%</span>
                      </div>
